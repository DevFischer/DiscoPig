...
####### POST FUNNY PICS #######
    ...
    async def cmd_usa(self, player, author):
        ...
        """
        return Response("https://cdn.pixabay.com/photo/2016/04/21/23/23/usa-1344768_960_720.png", delete_after=45)

    async def cmd_burn(self, player, author):
        """
        Get BURNED
        """
        return Response("http://i.imgur.com/EqHFa9m.gifv", delete_after=45)

    async def cmd_disco(self, player, author):
        """
        Lets get WILD
        """
        return Response("http://i.imgur.com/Ck26vp9.jpg", delete_after=45)

    async def cmd_groupw(self, player, author):
        """
        Dont fuck with the Group-W
        """
        return Response("http://i.imgur.com/W78KjXv.png", delete_after=45)

    async def cmd_butthurt(self, player, author):
        """
        Just in-case you get BUTTHURT
        """
        return Response("http://i.imgur.com/QuSEzgK.jpg", delete_after=45)

    async def cmd_dragons (self, player, author):
        """
        Do you like dragons?
        """
        return Response("http://i.imgur.com/15zm9HZ.png", delete_after=45)

    async def cmd_commands(self, player, author):
        """
        List of commands
        """
        return Response("\n/play\n/pause\n/resume", delete_after=45)

    async def cmd_virus(self, player, author):
        """
        Dont mess with The Slam Pig
        """
        return Response("http://i.imgur.com/Cv0tGNj.png", delete_after=45)

    async def cmd_canada(self, player, author):
        """
        CANADA SUCKS
        """
        return Response("http://i.imgur.com/DftcomG.png", delete_after=45)
